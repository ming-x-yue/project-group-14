...
public class SessionIntegrationTests {
    ...
    public void testCreateValidSession() {
        ...
        // Act
        ResponseEntity<SessionDTO> response = client.postForEntity("/create_session", request, SessionDTO.class);
        ...
        assertEquals(VALID_INSTRUCTOR_NAME, createdSession.getInstructor().getUsername());
        assertEquals(VALID_INSTRUCTOR_EMAIL, createdSession.getInstructor().getEmail());

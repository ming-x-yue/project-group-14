...
public class OwnerIntegrationTests {
    ...
    public void testCreateOwner() {
        ...
        assertEquals(VALID_USERNAME, createdOwner.getUsername());
    ...
    public void testReadOwnerByValidUsername() {
        ...
        assertNotNull(Owner);
        assertEquals(VALID_USERNAME, Owner.getUsername());
    ...
    public void testDeleteOwnerValidUsername() {
        ...
        assertEquals(VALID_USERNAME, Owner.getUsername());
        assertEquals(VALID_EMAIL, Owner.getEmail());
        assertEquals(VALID_PASSWORD, Owner.getPassword());
    }
    ...
    public void testUpdateOwnerUsername() {
        // Set up
        String url = "/Owner/update/" + this.VALID_USERNAME + "/" + this.VALID_USERNAME2 + "/" + this.VALID_EMAIL + "/"
                + this.VALID_PASSWORD;
        ...
        OwnerDTO Owner = response.getBody();
        assertNotNull(Owner);
        assertEquals(VALID_USERNAME2, Owner.getUsername());
        assertEquals(VALID_EMAIL, Owner.getEmail());
        assertEquals(VALID_PASSWORD, Owner.getPassword());
    }
    ...
    public void testUpdateOwnerEmail() {
        // Set up
        String url = "/Owner/update/" + this.VALID_USERNAME + "/" + this.VALID_USERNAME + "/" + this.VALID_EMAIL2 + "/"
                + this.VALID_PASSWORD;
        ...
        assertNotNull(Owner);
        assertEquals(VALID_USERNAME, Owner.getUsername());
        assertEquals(VALID_EMAIL2, Owner.getEmail());
        assertEquals(VALID_PASSWORD, Owner.getPassword());
    }
    ...
    public void testUpdateOwnerPassword() {
        // Set up
        String url = "/Owner/update/" + this.VALID_USERNAME + "/" + this.VALID_USERNAME + "/" + this.VALID_EMAIL + "/"
        ...
        assertEquals(VALID_USERNAME, Owner.getUsername());
        assertEquals(VALID_EMAIL, Owner.getEmail());
        assertEquals(VALID_PASSWORD2, Owner.getPassword());
    }
    /*
     * @Test
     * 
